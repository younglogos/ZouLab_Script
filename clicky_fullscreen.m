function [roi_points,intens,intens2] = clicky_oneChannel(movie_in, bin, refimg, bottom , top, titleofplot, wvlt)
% function [roi_points,intens,intens2] = clicky_fullscreen(movie_in, bin, refimg, bottom , top, titleofplot, movie_in2, wvlt)
...
% modified by Junqi Yang, 2021-5-7
