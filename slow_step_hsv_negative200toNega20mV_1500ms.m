...
clear all;
subfolder = '';
basepath = 'D:\data\test\20220222 Depolarization titration\Dish3\cell3\004736_40xWideField_bin2\';
pathname = basepath
...
xlswrite([pathname '1analysis.xlsx'],{'Vm', 'delta F(2354-2364 points)/F0', 'base_delta(740-750 potints) F/F0'},'A1:C1');
...
% xlswrite([pathname '1analysis.xlsx'],mean(peak2(1:90,:))','B4:B12');
xlswrite([pathname '1analysis.xlsx'],mean(dy_plat,1)','B2:B12');
xlswrite([pathname '1analysis.xlsx'],mean(dy_base,1)','C2:C12');
