...
%%
clear all;
basepath = 'H:\ZouLab\YJunqi\Photophysical property\Cepheid\20220519 Photocurrent test&deploarization titration\Dish1\cell1\163908_5V_405nm_pulse\'
subfolder = ''
WL = 561;%
...
space = kernel(peakloc-1000:peakloc+10000); % choose the suitable kernel range of X axis
figure()
plot(space)
...
space = kernel(peakloc-2000:peakloc+5000); % choose the suitable kernel range of X axis
figure()
plot(space)
