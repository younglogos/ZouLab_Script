...
bin = 1;
basepath = 'X:\91 Data and analysis\YJunqi\Screening method\Stimulus pre-experiments\20211121 Gramicidin test\Dish3\test';
subfolder = '\';
...
%% save 2 movies
expGroup = 'analysis\onlyArcLight\'
...
delta_intens1 = (intens_norm_wobkg - mean(intens_norm_wobkg(1:18, :)))./mean(intens_norm_wobkg(1:18,:));
delta_intens2 = (intens2_norm_wobkg - mean(intens2_norm_wobkg(1:18, :)))./mean(intens2_norm_wobkg(1:18));
