...
bin = 1;
basepath = 'X:\91 Data and analysis\YJunqi\Screening method\Stimulus pre-experiments\20111128 Gramicidin test\Dish2\test';
subfolder = '\';
...
%% save 2 movies
expGroup = 'analysis\ArcLight+HASAP1\'
...
saveas(gca,[pathname expGroup 'bkg_trace_' num2str(name1) '_.fig']);
saveas(gca,[pathname expGroup 'bkg_trace_' num2str(name1) '_.png']);
...
xlabel('Time (s)')
ylabel('normalized intensity for bkg correction')
saveas(gca,[pathname expGroup 'selected bkg' num2str(name2) '.fig']);
saveas(gca,[pathname expGroup 'selected bkg' num2str(name2) '.png']);
%% analysis
...
xlabel('time (s)')
legend('Cell 1', 'Cell 2','Cell 3', 'Cell 4','Cell 5', 'Cell 6','Cell 7', 'Cell 8','Cell 9', 'Cell 10','Cell 11', 'Cell 12','Cell 13', 'Cell 14','Cell 15', 'Cell 16','Cell 17', 'Cell 18','Cell 19','Cell 20','Cell 21','Cell 22','Cell 23','Cell 24', 'Location','Best')
legend('boxoff')
...
legend('Cell 1', 'Cell 2','Cell 3', 'Cell 4','Cell 5', 'Cell 6','Cell 7', 'Cell 8','Cell 9', 'Cell 10','Cell 11', 'Cell 12','Cell 13', 'Cell 14','Cell 15','Cell 16','Cell 17', 'Cell 18','Cell 19','Cell 20','Cell 20','Cell 21','Cell 22','Cell 23','Cell 24','Location','Best')
legend('boxoff')
...
set(seShoadow1(2),'FaceColor',[0.46, 0.68, 0.17]' ,'FaceAlpha',0.5, 'EdgeColor', 'none');
...
set(seShoadow2(2),'FaceColor',[0.85, 0.32, 0]' ,'FaceAlpha',0.4, 'EdgeColor', 'none');
plot1 = plot(t_mov, mean(intens_norm_wobkg,2), 'Color', name1color,'LineWidth',1.5);
plot2 = plot(t_mov, mean(intens2_norm_wobkg,2), 'Color', name2color,'LineWidth',1.5);
legend([plot1, plot2], {name1, name2}, 'Location','northoutside','Orientation','horizontal');
box off;
axis tight;
xlabel('Time(s)');
ylabel('Relative intensity')
...
figure()
seShoadow1_2 = area(t_mov, [(mean(delta_intens1, 2) - delta_sem1), (2 * delta_sem1)]);
hold on;
set(seShoadow1_2(1),'Visible','off');
%set(seShoadow1_2(2),'FaceColor',[0.85, 0.32, 0]' ,'FaceAlpha',0.4, 'EdgeColor', 'none');
set(seShoadow1_2(2),'FaceColor',[0, 1, 1]' ,'FaceAlpha',0.3, 'EdgeColor', 'none');
seShoadow2_2 = area(t_mov, [(mean(delta_intens2, 2) - delta_sem2), (2 * delta_sem2)]);
hold on;
set(seShoadow2_2(1),'Visible','off');
%set(seShoadow2_2(2),'FaceColor',[0.46, 0.68, 0.17]' ,'FaceAlpha',0.4, 'EdgeColor', 'none');
set(seShoadow2_2(2), 'FaceColor', [1, 0, 1]' , 'FaceAlpha',0.2, 'EdgeColor', 'none');
plot1 = plot(t_mov, mean(delta_intens1,2), 'Color', name1color,'LineWidth',1.5);
plot2 = plot(t_mov, mean(delta_intens2,2), 'Color', name2color,'LineWidth',1.5);
legend([plot1, plot2], {name1, name2}, 'Location','northoutside','Orientation','horizontal');
box off;
axis tight;
xlabel('Time(s)');
