...
subfolder = '';
basepath = 'C:\Users\ZouOptics\Desktop\22.05.31\A0023+Cheriff\022834_405-5V-step+594-1V\';
pathname = [basepath subfolder];

load ([pathname '\SNAPT-300ms on_1700 ms off- 5V_4643.6034\matlab variables.mat']);%输入激光文件夹名称
wavelength = 405
;%输入波长信息
% Fs = samprate;
% constants
