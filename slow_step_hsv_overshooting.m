...
clear all;
subfolder = '\';
basepath = 'H:\ZouLab\YJunqi\Screening method\System test\20220507 Depolarization titration\Dish3\cell2\211352_-100 to +100_500ms\';
...
xlswrite([pathname 'analysis.xlsx'],{'Vm', 'peak_delta(263:363 points) F/F0', 'plat(737-747 points)_delta F/F0', 'base_delta(105-215 potints) F/F0'},'A1:D1');
xlswrite([pathname 'analysis.xlsx'],{-100, -80, -60, -40, -20, 0, 20, 40, 60, 80, 100}','A2:A12');
xlswrite([pathname 'analysis.xlsx'],mean(peak1(1:100,:))','B2:B3');
xlswrite([pathname 'analysis.xlsx'],mean(peak2(1:30,:))','B4:B12');
% xlswrite([pathname 'analysis.xlsx'],mean(dy_peak,1)','B2:B12');
xlswrite([pathname 'analysis.xlsx'],mean(dy_plat,1)','C2:C12');
xlswrite([pathname 'analysis.xlsx'],mean(dy_base,1)','D2:D12');
